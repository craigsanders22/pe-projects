<section class="center-content">
    <inner-column>
        ...
        <div class="video-player">
            <iframe width="600" height="300" src="https://www.youtube.com/embed/FLcGTO326GQ?si=jcaaGGcgq_qqum1N" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
        </div>
        <?php endif; ?>
