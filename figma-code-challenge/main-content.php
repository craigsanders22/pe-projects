<section class="center-content">
    <inner-column>
        ...
        <div class="video-player">
            <iframe width="600" height="400" src="https://www.youtube.com/embed/8O_ifyIIrN4?si=iZEGY8n3JYV6J0Dx" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
        </div>
        <?php endif; ?>
