<html>
	...
	<body>
		...
		<p> We have to walk <?php echo $adverbOne?> to get there without " . $verbOne . ". There are " . $animalOne . " and " . $animalTwo . " which are very " . $adjectiveTwo . ". We eat lots of food that everyone " . $adjectiveThree .  ". The games are my favorite part.</p>
