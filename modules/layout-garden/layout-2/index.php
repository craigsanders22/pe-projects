			...
			<section class="articles">
				<ul>
					...
					<li>
						<article>
							<picture>
								<img src="https://www.rei.com/assets/adventures/images/homepage/about/about-hero-tile/live.jpg" alt="">
							</picture>
							<div class="adventure-text">
								<h3 class="attention-voice"> Adventure travel done right</h3>
					...
					<li>
						<article>
							<picture>
								<img src="https://www.rei.com/assets/adventures/images/homepage/about/about-uncommon-tile/live.jpg" alt="">
							</picture>
							<div class="adventure-text">
					...
					<li>
						<article>
							<picture>
								<img src="https://www.rei.com/assets/adventures/images/homepage/about/about-guide-tile/live.jpg" alt="">
							</picture>
							<div class="adventure-text">
								<h3 class="strong-voice">
					...
					<li>
						<article>
							<picture>
								<img src="https://www.rei.com/assets/adventures/images/homepage/about/about-decades-tile/live.jpg" alt="">
							</picture>
							<div class="adventure-text">
								<h3 class="strong-voice">
